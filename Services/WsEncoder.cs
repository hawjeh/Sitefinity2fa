...
namespace System.Text
{
    ...
    public class WsEncoder
    {
        ...
        public WsEncoder() : this(DEF_ENCODING_TABLE, DEF_PADDING) { }
        public WsEncoder(char padding) : this(DEF_ENCODING_TABLE, padding) { }
        public WsEncoder(string encodingTable) : this(encodingTable, DEF_PADDING) { }

        public WsEncoder(string encodingTable, char padding)
        {
